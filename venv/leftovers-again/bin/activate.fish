...
set -gx VIRTUAL_ENV /home/gyarados/leftovers-again
...
if test -z "$VIRTUAL_ENV_DISABLE_PROMPT"
    ...
    function fish_prompt
        ...
        printf "%s%s%s" (set_color 4B8BBE) '(leftovers-again) ' (set_color normal)
    ...
    set -gx VIRTUAL_ENV_PROMPT '(leftovers-again) '
end
...
if test -z "$NODE_VIRTUAL_ENV_DISABLE_PROMPT"
    ...
    function fish_prompt
        ...
        if test -n "(leftovers-again)"
            printf '%s%s ' "(leftovers-again)" (set_color normal)
        else
